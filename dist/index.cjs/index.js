...
exports.generateMetalnessMap = generateMetalnessMap;
exports.generateNormalMap = generateNormalMap;
exports.generateRoughnessMap = generateRoughnessMap;
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 2:
          ...
          return Promise.resolve().then(function () {
            return _interopRequireWildcard(require("canvas"));
          });
        case 4:
      ...
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          return _context2.abrupt("return", new Promise(function (resolve, reject) {
            ...
            if (isNode) {
              _fs["default"].readFile(input, function (err, data) {
...
function generateRoughnessMap(_x2) {
...
function generateNormalMap(_x3) {
...
function generateMetalnessMap(_x4) {
